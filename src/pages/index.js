...
export const IndexPage = () => {
  const schema =
  {
    ...
    "description": "smart passionate techie looking to start his career, certified full stack ,versed in serverless wordpress shopify gatsby front End front-end back end back-end",
